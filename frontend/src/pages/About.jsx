    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-12">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/3 text-sm text-gray-600">
          <p>
            Welcome to DocCare, your trusted partner in managing your healthcare
            needs conveniently and efficiently. At DocCare, we understand the
          ...
          <p>
            Our vision at DocCare is to create a seamless healthcare experience
      ...
      <div className="flex flex-col md:flex-row mb-30">
