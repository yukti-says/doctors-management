...
const Header = () => {
  return (
    <div className="flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20">
      {/* --- SECTION 01  for text buttons and text left side*/}
      <div className="md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]">
        <p className="text-white text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight md:leading-tight lg:leading-tight">
          ...
          <br />
          <span className="text-yellow-400 drop-shadow-[0_0_8px_rgba(89,234,200,0.8)] font-extrabold">
            Book Smarter
          </span>
        </p>
      ...
      {/* --- SECTION 02 for right side of part */}
