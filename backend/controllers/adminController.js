...
const addDoctor = async (req, res) => {
  try {
    ...
    // accept either 'fee' or 'fees' from client
    fee = fee || fees;
...
//& displaying the whole data for admin dashboard
const adminDashboard = async (req, res) => {
  try {
    ...
    //& sending the number of doctors users and appointment meaning sending the length of each
    const dashData = {
